...
const updateAge = () => {
  ...
  const remainingtime=dateDiff-year*(1000*60*60*24*365.25)
  const month = Math.floor((remainingtime / (1000 * 60 * 60 * 24 *30.44)));
  const day = Math.floor((remainingtime % (1000 * 60 * 60 * 24*30.44))/(1000*60*60*24));
